...
export function Features() {
    return (
        <section className="py-24 lg:py-32 relative">
            {/* Premium Background */}
            <div className="absolute inset-0 bg-content-premium" />
                ...
                >
                    {features.map((feature, idx) => (
                        <motion.div
                            ...
                            className="group glass-card rounded-2xl p-6 border border-white/20 hover:border-primary/30 transition-all duration-300 shadow-premium-medium hover:shadow-premium-strong"
                        >
                            {/* Icon */}
