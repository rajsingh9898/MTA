...
export function HeroBackground() {
    return (
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-20 left-10 w-32 h-32 bg-amber-100 rounded-full opacity-20 blur-3xl" />
            <div className="absolute top-40 right-20 w-40 h-40 bg-yellow-100 rounded-full opacity-15 blur-3xl" />
            <div className="absolute bottom-60 left-1/4 w-36 h-36 bg-cream-100 rounded-full opacity-10 blur-2xl" />
        </div>
    )
}
